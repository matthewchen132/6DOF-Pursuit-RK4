...
execute_process(
  COMMAND "/opt/local/bin/git" --git-dir=.git show-ref "v1.2.1"
  WORKING_DIRECTORY "/Users/awolf/Code/6DOF-Missile-Sim/6DOF-Pursuit-RK4/cpp/_deps/matplotplusplus-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/awolf/Code/6DOF-Missile-Sim/6DOF-Pursuit-RK4/cpp/_deps/matplotplusplus-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/awolf/Code/6DOF-Missile-Sim/6DOF-Pursuit-RK4/cpp/_deps/matplotplusplus-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
